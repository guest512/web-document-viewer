...
Text:{},/**
     ...
     */
Utils:{}});!function(){Atalasoft.Controls.Version=[11,0,0,0];var t={instanceCounter:0};/**
...
function T(){if(qt.annos.length>0){if(qt.annos.length=0,Et)for(var e=0;e<Et.length;e++)Et[e]._grips.clear(),Et[e]._paper.forEach(m),Et[e]._paper._trash.remove(),Et[e]._paper._trash.clear(),Et[e]._paper._annos.remove(),Et[e]._paper._annos.clear();Ot.trigger({type:"annotationscleared"})}}/**
    ...
    */
function E(e,t,n){var a={};e.multiview?a=e:(e&&e.type&&Gt[e.type]&&Rt.extend(!0,a,Gt[e.type]),Rt.extend(!0,a,e));var o=new Atalasoft.Annotations.Annotation(a,qt);return o._pageindex=t,"undefined"==typeof qt.annos[t]&&(qt.annos[t]=[]),qt.annos[t].push(o),zt.redrawPageFromIndex(t,!0),"function"==typeof n&&n(o),gt(o),o}function I(e,t,n){var a=E(e,t,n).getClonedData();return Ot.trigger({type:Xt.annocreate,anno:a,annotation:a,page:t}),a}function M(e,t){U(t,e)}/**
    ...
    */
function U(e,t){var n=qt.annos[t].splice(e,1)[0];qt.activepage&&qt.activepage._paper._annos.exclude(n.getObject()),qt.activeanno===n&&(qt.activeanno=null),n.dispose(),qt.activepage&&qt.activepage._grips.repaint(),Ot.trigger({type:"annotationdeleted",page:t,index:e})}function L(e){var t=[];if(0===qt.annos.length||"undefined"==typeof qt.annos[e])return t;for(var n=0;n<qt.annos[e].length;n++)t[n]=qt.annos[e][n].getClonedData();return t}function j(e,t){var n;if(isFinite(t)){if(t<qt.annos.length)for(n=0;n<qt.annos[t].length;++n)if(qt.annos[t][n].isCloneSource(e))return qt.annos[t][n]}else for(n=0;n<qt.annos.length;++n){var a=j(e,n);if(a)return a}return null}function N(e,t,n,a){n=h(e,t,n),"function"==typeof a&&a(),Ot.trigger({type:Xt.layerinserted,srcurl:e,srcindex:t,index:n}),Ot.trigger(Xt.layerschanged)}function H(e,t){var n=v(e);"function"==typeof t&&t(),Ot.trigger({type:Xt.layerremoved,layer:n,index:e}),Ot.trigger(Xt.layerschanged)}function q(e,t,n){t=y(e,t),"function"==typeof n&&n(),Ot.trigger({type:Xt.layermoved,srcindex:e,destindex:t}),Ot.trigger(Xt.layerschanged)}function G(e){Tt.annotations.defaults=e;for(var t=0;t<e.length;t++)"string"==typeof e[t].type&&(Gt[e[t].type]=e[t]);return Ot}function Q(e){Tt.annotations.stamps=e;for(var t=0;t<e.length;t++)Dt(e[t]);if(It){var n={type:"button",id:zt._id+"_toolbar_Button_Stamp",icon:"stamp",tooltip:"Draw Stamp",text:""},a=zt.createDropDownButton(n);n.onclick=zt.drawAnnotation,zt.createDropDownMenu(a,n,e)}return Ot}function J(e){Tt.annotations.images=e;for(var t=0;t<e.length;t++)Pt(e[t]);if(It){var n={type:"button",id:zt._id+"_toolbar_Button_Image",icon:"image",tooltip:"Draw Image",text:""},a=zt.createDropDownButton(n);n.onclick=zt.drawAnnotation,zt.createDropDownMenu(a,n,e)}return Ot}/**
...
getAnnotationsFromPage:L,/**
         ...
         */
deleteAnnotationOnPageAtIndex:M,/**
         * @instance
         * @memberOf Atalasoft.Controls.WebDocumentViewer
         * @function
...
/**
             ...
             */
text:{value:null,align:"left",font:{bold:!1,italic:!1,strike:!1,underline:!1,color:"black",family:"Arial",size:12},readonly:!1,replies:null,parent:null},/**
...
"use strict";Atalasoft.Annotations.AnnotationTextRenderer=function(t,e){function n(){o(),c=h("<canvas "+(g?'dir="rtl"':"")+"/>"),x=h('<span style="position:absolute; visibility:hidden; left: -5000px;">{[|,0123456789Thqkbfjplyg</span>'),h(document.body).append(x)}function o(){var t,e=document.body;e.currentStyle?t=e.currentStyle.direction:window.getComputedStyle&&(t=document.defaultView.getComputedStyle(e,null).getPropertyValue("direction")),"rtl"===t.toLowerCase()&&(g=!0)}function i(){f=null,p=null,d=null,c&&c.remove&&(c.remove(),c=null),x&&x.remove&&(x.remove(),x=null)}function l(t){c&&x||n(),d.applyTo(x),c[0].width=t.width,c[0].height=t.height;var e=c[0].getContext("2d"),o=[p.text.font.italic?"italic":"normal",p.text.font.bold?"bold":"normal",p.text.font.size+"px",p.text.font.family];e.font=o.join(" "),e.fillStyle=p.text.font.color,e.textAlign="start",e.textBaseline="top";for(var i=a(e,p.text.value,t.width),l=0,r=u(),s=e.measureText(p.text.value).width,h=g?t.width:0,f=0;f<i.length;f++)e.fillText(i[f],h,l,s),l+=r;return c[0].toDataURL()}function r(t,e){t.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",l(e))}function u(){return d.applyTo(x,1),x[0].offsetHeight}function a(t,e,n){var o=[],i=[];if("string"==typeof e){for(var l="\n",r=e,u=n,a=s(r),f="",p="",d=0;d<a.length;d++)if(f=p,p=a[d],t.measureText(p).width>u)for(var c=p.split(""),x=0;x<c.length;x++)i.push(c[x]),t.measureText(i.join("")).width>u&&(i.pop(),o.push(i.join("")),i.length=0,i.push(c[x]));else i.push(p),(t.measureText(h.trim(i.join(""))).width>u||f.indexOf(l)>=0)&&(i.pop(),o.push(i.join("")),i.length=0,i.push(p));i.length>0&&(o.push(i.join("")),i.length=0)}return o}function s(t){for(var e=[],n="",o=0,i=0;i<t.length;i++){var l=t[i];m[n]&&(e.push(t.substr(o,i-o)),o=i),n=l}return i>o&&e.push(t.substr(o,i-o)),e}var h=Atalasoft.$,f=this,p=t,d=e,c=null,x=null,g=!1,m={" ":!0,"-":!0,"?":!0,"\n":!0,"	":!0};f.dispose=i,f.renderToDataURL=l,f.renderToSVGImage=r};
...
function P(){}function I(){}function M(){}/**
     ...
     * @returns {number}
     */
function T(){return Nt}function C(e){var t=1,o=function(){t--,0>=t&&(l()&&an&&Zt&&d(Zt,!0),"function"==typeof e&&e.call())};l()&&(an?an.closeDocument(n(),Jt):Zt.isReady()&&(t++,Zt.empty(o))),F(o)}function F(){}function q(){l()&&(an?an.closeDocument(n(),Jt):Zt.empty(),u()),A(),Zt=null,Gt=null}function A(){}function k(e,t,o,a){ct(),null==a&&("function"==typeof t?(a=t,t=null):"function"==typeof o&&(a=o,o=null));var i=function(e){E(),It(e,a)};"string"==typeof e&&an.closeDocument(n(),Jt),O(e,t,o,i)}function O(){}function E(){Bt.scrollTo(0,0,!1)}function S(e){sn.base&&(0>Nt&&(Nt=0),Yt.each(sn.base.dom.pageDivs,function(t,n){var o=!1;n._index===Nt&&e?(n.addClass(Bt.domclasses.atala_active_thumb),o=!0):n.removeClass(Bt.domclasses.atala_active_thumb),U(n,o)}))}/**
